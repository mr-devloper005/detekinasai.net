...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#30363d',
  '--slot4-panel-bg': '#eef2f5',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#68727d',
  '--slot4-soft-muted-text': '#929aa3',
  '--slot4-accent': '#39aeca',
  '--slot4-accent-fill': '#39aeca',
  '--slot4-accent-soft': '#e1f5f9',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#303234',
  ...
  '--editable-page-bg': '#f5f7fa',
  '--editable-page-text': '#30363d',
  '--editable-container': '1180px',
  '--editable-border': '#dce2e7',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#1a1a1a',
  '--editable-nav-active': '#19347d',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#19347d',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#303234',
